...
class QuranServicesTask extends BackgroundAudioTask {
  ...
  void onStart(Map<String, dynamic> params) {
    ...
    _playerStateSubscription = _player.playbackStateStream
  ...
  Future<void> _seekRelative(Duration offset) async {
    var newPosition = _player.playbackEvent.position + offset;
    ...
    await _player.seek(_player.playbackEvent.position + offset);
  }
